...
try:
    ...
    def _patch_dist_info():
        ...
        css_dist = metadata.distribution("certifi_system_store")
        css_egg_info = str(css_dist._path)
        try:
            certifi_dist = metadata.distribution("certifi")
            certifi_egg_info = str(certifi_dist._path)
